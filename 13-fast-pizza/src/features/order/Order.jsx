...
function Order() {
  //load menu datta in  order page directly
    ...
    <div className="py-6 px-4 space-y-8">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="space-x-2">
          {priority && <span className="bg-red-500 tracking-wide text-red-50 rounded-full py-1 px-3 text-sm uppercase font-semibold">Priority</span>}
      ...
      <div className="space-y-2 bg-slate-200 py-5 px-6">
